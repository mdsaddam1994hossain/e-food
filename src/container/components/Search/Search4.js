    ...
    return (
        <div className="common-top-margin">
            <Row>
                ...
                <Col xs={{ offset: 2, span: 20 }} sm={{ offset: 4, span: 16 }} md={{ offset: 6, span: 12 }} lg={{ offset: 8, span: 8 }} style={{ marginTop: "20px", display: "flex", justifyContent: "space-between" }} >
                    <p className="catagoris">CATEGORIES</p>
                    <p className="view-all">VIEW ALL</p>
                </Col> 

                <Col xs={{ offset: 2, span: 20 }} sm={{ offset: 4, span: 16 }} md={{ offset: 6, span: 12 }} lg={{ offset: 8, span: 8 }} style={{ display: "flex" }} >
